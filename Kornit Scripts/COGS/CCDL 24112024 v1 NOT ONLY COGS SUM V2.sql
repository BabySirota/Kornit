...
,      FOR_SUM_LAYER.GL_SL_LINK_ID              
,      FOR_SUM_LAYER.GL_SL_LINK_TABLE           
,      FOR_SUM_LAYER.XTE_TRANSACTION_NUMBER     
,      FOR_SUM_LAYER.ACCOUNTING_CLASS_CODE      
,      FOR_SUM_LAYER.ACCOUNTING_CLASS_MEANING   
,      FOR_SUM_LAYER.BUSINESS_CLASS_CODE        
,      FOR_SUM_LAYER.XAL_PARTY_ID               
,      FOR_SUM_LAYER.XAL_PARTY_SITE_ID          
,      FOR_SUM_LAYER.ACCOUNTING_ENTRY_TYPE_CODE 
/*
,      MAX ( FOR_SUM_LAYER.FULFILLMENT_DATE )   FULFILLMENT_DATE
,      MAX ( FOR_SUM_LAYER.ORDER_LINE_NUMBER	)   ORDER_LINE_NUMBER 
,      MAX (  FOR_SUM_LAYER.ORDER_DISPLAY_LINE_NUMBER	 )  ORDER_DISPLAY_LINE_NUMBER
,      MAX ( FOR_SUM_LAYER.FULFILL_LINE_NUMBER	 )  FULFILL_LINE_NUMBER
